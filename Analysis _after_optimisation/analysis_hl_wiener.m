...
nac_22=wiener2(ac,[2,2]);
figure 
imshow(nac_22);

nac_33=wiener2(ac,[3,3]);
figure 
imshow(nac_33);

nac_55=wiener2(ac,[5,5]);
figure 
imshow(nac_55);

nac_77=wiener2(ac,[7,7]);
figure 
imshow(nac_77);

nac_99=wiener2(ac,[9,9]);
figure 
imshow(nac_99);

nac_1111=wiener2(ac,[11,11]);
figure 
imshow(nac_1111);

nac_1313=wiener2(ac,[13,13]);
figure 
imshow(nac_1313);
