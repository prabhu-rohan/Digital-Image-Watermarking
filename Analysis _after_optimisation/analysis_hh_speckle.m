...
nac_sp=imnoise(ac,'speckle',0.5);
figure 
imshow(nac_sp);

nac_sp1=imnoise(ac,'speckle',0.3);
figure 
imshow(nac_sp1);

nac_sp2=imnoise(ac,'speckle',0.1);
figure 
imshow(nac_sp2);

nac_sp3=imnoise(ac,'speckle',0.05);
figure 
imshow(nac_sp3);

nac_sp4=imnoise(ac,'speckle',0.01);
figure 
imshow(nac_sp4);

nac_sp5=imnoise(ac,'speckle',0.005);
figure 
imshow(nac_sp5);
