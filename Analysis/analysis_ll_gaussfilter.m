...
nac_22=imgaussfilt(ac,2);
figure 
imshow(nac_22);

nac_33=imgaussfilt(ac,3);
figure 
imshow(nac_33);

nac_55=imgaussfilt(ac,5);
figure 
imshow(nac_55);

nac_77=imgaussfilt(ac,7);
figure 
imshow(nac_77);

nac_99=imgaussfilt(ac,9);
figure 
imshow(nac_99);

nac_1111=imgaussfilt(ac,11);
figure 
imshow(nac_1111);

nac_1313=imgaussfilt(ac,13);
figure 
imshow(nac_1313);
