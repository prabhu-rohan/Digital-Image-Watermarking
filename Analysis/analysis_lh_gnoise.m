...
nac_22=imnoise(ac,'gaussian',0.5);
figure 
imshow(nac_22);

nac_33=imnoise(ac,'gaussian',0.3);
figure 
imshow(nac_33);

nac_55=imnoise(ac,'gaussian',0.1);
figure 
imshow(nac_55);

nac_77=imnoise(ac,'gaussian',0.05);
figure 
imshow(nac_77);

nac_99=imnoise(ac,'gaussian',0.01);
figure 
imshow(nac_99);

nac_1111=imnoise(ac,'gaussian',0.005);
figure 
imshow(nac_1111);
